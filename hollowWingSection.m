function []=hollowWingSection(skinThickness,sparPos1,sparPos2,sparPos3)
...
TE_Fwd_Extension=pointRelativeTo(-.05,0,TE_Middle);
...
PointAhead=createPointInSpace(-.1,0);
PointLessAhead=createPointInSpace(.1,0);
...
spar1_center_above=createPointInSpace(sparPos1,.5);
spar1_center_below=createPointInSpace(sparPos1,-.5);
...
spar2_center_above=createPointInSpace(sparPos2,.5);
spar2_center_below=createPointInSpace(sparPos2,-.5);
...
spar3_center_above=createPointInSpace(sparPos3,.5);
spar3_center_below=createPointInSpace(sparPos3,-.5);
